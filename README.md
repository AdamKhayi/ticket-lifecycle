...
This project is going to demonstrate the lifecycle of a ticket from creation to resolution within osTicket.<br />
...
<p>
  <img src="https://i.imgur.com/Sl2oIIC.png" height="75%" width="100%" alt="Sys admin agent login"/>
</p>
<p>
  Agent Jane works the issue and communicates back to agent John.
</p>
<p>
  Jane switches the status of the issue from open to resolved:
</p>
<br />
<br />
...
<br />
<p>
  This concludes the end of the project. This project just demonstrated the creation of a ticket, assignment, and communication of a ticket between agents, and resolving the issue.
</p>
